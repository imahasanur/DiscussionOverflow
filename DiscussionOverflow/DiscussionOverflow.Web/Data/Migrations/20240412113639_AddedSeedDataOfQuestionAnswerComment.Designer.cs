...
namespace DiscussionOverflow.Web.Data.Migrations
{
    ...
    [Migration("20240412113639_AddedSeedDataOfQuestionAnswerComment")]
    partial class AddedSeedDataOfQuestionAnswerComment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DiscussionOverflow.Domain.Entities.Answer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TimeStamp = new DateTime(2024, 4, 12, 17, 36, 39, 455, DateTimeKind.Local).AddTicks(3889)
                        },
                        new
                        {
                            ...
                            TimeStamp = new DateTime(2024, 4, 12, 17, 36, 39, 455, DateTimeKind.Local).AddTicks(3896)
                        });
                });
            ...
            modelBuilder.Entity("DiscussionOverflow.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            QuestionId = new Guid("003805c3-938c-43b7-a768-03d6c0242ece"),
                            QuestionMaker = "skill1@gmail.com",
                            TimeStamp = new DateTime(2024, 4, 12, 17, 36, 39, 455, DateTimeKind.Local).AddTicks(3943)
                        },
                        new
                        {
                            ...
                            Commentator = "skill2@gmail.com",
                            Replier = "skill1@gmail.com",
                            TimeStamp = new DateTime(2024, 4, 12, 17, 36, 39, 455, DateTimeKind.Local).AddTicks(3954)
                        });
                });
            ...
            modelBuilder.Entity("DiscussionOverflow.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            QuestionMaker = "skill1@gmail.com",
                            Tags = "C,F,D",
                            TimeStamp = new DateTime(2024, 4, 12, 17, 36, 39, 455, DateTimeKind.Local).AddTicks(3165),
                        ...
                        new
                        {
                            ...
                            QuestionMaker = "skill1@gmail.com",
                            Tags = "C,F,D,E",
                            TimeStamp = new DateTime(2024, 4, 12, 17, 36, 39, 455, DateTimeKind.Local).AddTicks(3193),
